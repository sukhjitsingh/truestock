...
state whether it is upheld, violated, or not yet applicable, and cite the file and line
that proves it. Use the `code-reviewer` agent. Report only — do not fix anything.
