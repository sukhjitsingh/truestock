...
// imported from another file. Same guard as db/seed.ts:363 — comparing
// import.meta.url against pathToFileURL(process.argv[1]).href is portable
// across Node and Bun (import.meta.main is Bun-only). Without it, importing
// this module from a test or REPL would unconditionally prompt for a
// password (or hang waiting on a TTY) and issue a live user-creation write
// against whatever DATABASE_URL happens to be active.
